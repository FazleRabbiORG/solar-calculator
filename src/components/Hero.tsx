    ...
    <div className="relative min-h-[500px] lg:min-h-[500px]">
      ...
      <div className="text-white min-h-[300px] lg:min-h-[300px] flex items-end relative h-full">
        <div className="container mx-auto relative h-full flex flex-col justify-end p-5 m-5">
          <h1 className="text-4xl font-bold mb-4">W Power Pachtpreisrechner</h1>
          <p className="mb-8">Nutzen Sie jetzt unseren Pachtpreisrechner und erhalten Sie Ihre persönliche <br /> Pachtschätzung bequem innerhalb von 10 Minuten per E-Mail.</p>
