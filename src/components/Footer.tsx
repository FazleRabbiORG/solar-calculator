    ...
    <footer className="bg-green-600 dark:bg-green-800 text-white py-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-bold mb-4">FlächenMakler</h3>
            <p>Vermittlung von Agrar- oder Grünflächen sowie Gewerbe- und Industrieflächen an Photovoltaik-Investoren.</p>
          </div>
          <div>
            <h3 className="font-bold mb-4">ÜBER UNS</h3>
            <ul>
              <li><Link href="/fur-projektentwickler">Für Projektentwickler</Link></li>
              <li><Link href="/tippgeber">Tippgeber</Link></li>
              <li><Link href="/magazin">Magazin</Link></li>
          ...
          <div>
            ...
            <ul>
              <li><Link href="/dachflachen">Dachflächen</Link></li>
              <li><Link href="/freiflachen">Freiflächen</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-8 text-center">
          <p>© 2024 FlächenMakler. Alle Rechte vorbehalten.</p>
